...
namespace CardiacMonitor.Services
{
        ...
        public interface IPatientService
        {
            ...
            Task<IEnumerable<PatientVitalsSummaryDto>> GetFixedPerformanceAsync();
            Task<PatientFullDashboardDto?> GetFullDashboardAsync(int id);
            Task<IEnumerable<PatientProjectionDto>> GetPatientsWithProjectionAsync();
