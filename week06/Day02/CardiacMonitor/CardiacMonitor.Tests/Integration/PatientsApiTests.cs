...
public sealed class CardiacMonitorWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        // We use a local logger so that ILogger remains effective within the test without relying on Windows Event Log.
...
public class PatientsApiTests : IClassFixture<CardiacMonitorWebApplicationFactory>
{
    ...
    // We obtain a genuine JWT from the endpoint login as required by the material for endpoint protection testing.
